...
@section('content')
    <div class="container mx-auto p-6">
        ...
        <div class="flex items-center mb-6 space-x-4">
            <div class="relative flex-1">
                <input type="text" id="search" name="search" value="{{ request()->get('search') }}" placeholder="Buscar torneos..." class="form-input border border-gray-300 rounded-lg px-4 py-2 w-full focus:ring-2 focus:ring-blue-500 shadow-md placeholder-gray-500">
        ...
        <a href="{{ route('admin.torneos.create') }}" class="inline-flex items-center py-2 px-4 border border-transparent text-base font-medium rounded-lg shadow-lg text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 mb-6">
            <i class="bi bi-plus-circle mr-2"></i> Crear Torneo
        </a>
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <div class="p-6">
                <div id="torneos-list">
                    @include('admin.torneos.partials.torneos_list', ['torneos' => $torneos])
                </div>
                <div id="pagination" class="mt-6">
                    {{ $torneos->appends(request()->except('page'))->links('pagination::tailwind') }}
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="delete-modal" class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 hidden">
        <div class="bg-white p-6 rounded-lg shadow-lg text-center w-full max-w-sm">
            ...
            <p class="mb-4">¿Estás seguro de que deseas eliminar este torneo? Esta acción no se puede deshacer.</p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function fetchResults(query) {
                fetch('{{ route('admin.torneos.index') }}' + '?search=' + query, {
                    headers: {
                ...
                .then(data => {
                    torneosList.innerHTML = data.html;
            ...
            document.addEventListener('click', function(e) {
                if (e.target.matches('.delete-torneo')) {
                    e.preventDefault();
