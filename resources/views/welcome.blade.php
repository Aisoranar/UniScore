    ...
    <section class="welcome-section bg-gradient-to-r from-green-500 to-blue-600 text-white py-12">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="p-6 bg-white bg-opacity-20 shadow-lg rounded-lg mx-auto max-w-lg">
                ...
                <a href="{{ route('login') }}" class="inline-block px-4 py-2 bg-blue-600 text-white font-semibold rounded-lg shadow-lg hover:bg-blue-700 transition-colors duration-300">Iniciar Sesión</a>
            </div>
            @endguest
            ...
            @if(auth()->user()->role == 'superadmin')
                <div class="p-6 bg-white bg-opacity-20 shadow-lg rounded-lg mx-auto max-w-lg">
                    ...
                    <p class="text-lg mb-6 text-black">Como Superadministrador, tienes acceso completo para gestionar torneos y usuarios. Utiliza nuestras herramientas avanzadas para facilitar tu trabajo.</p>
                    <a href="{{ route('logout.perform') }}" class="inline-block px-4 py-2 bg-red-600 text-white font-semibold rounded-lg shadow-lg hover:bg-red-700 transition-colors duration-300">Cerrar Sesión</a>
                </div>
            @elseif(auth()->user()->role == 'coach')
                <div class="p-6 bg-white bg-opacity-20 shadow-lg rounded-lg mx-auto max-w-lg">
                    ...
                    <h2 class="text-3xl font-bold mb-4 text-black">¡Hola, {{ auth()->user()->name ?? auth()->user()->username }}!</h2>
                    <p class="text-lg mb-6 text-black">Como Entrenador, puedes gestionar tus equipos y ver estadísticas detalladas. Utiliza nuestras herramientas avanzadas para facilitar tu trabajo.</p>
                    <a href="{{ route('logout.perform') }}" class="inline-block px-4 py-2 bg-red-600 text-white font-semibold rounded-lg shadow-lg hover:bg-red-700 transition-colors duration-300">Cerrar Sesión</a>
                </div>
            @elseif(auth()->user()->role == 'trainee')
                <div class="p-6 bg-white bg-opacity-20 shadow-lg rounded-lg mx-auto max-w-lg">
                    ...
                    <h2 class="text-3xl font-bold mb-4 text-black">¡Hola, {{ auth()->user()->name ?? auth()->user()->username }}!</h2>
                    <p class="text-lg mb-6 text-black">Como Aprendiz, puedes ver tus estadísticas y el progreso de tus entrenamientos. Utiliza nuestras herramientas avanzadas para facilitar tu aprendizaje.</p>
                    <a href="{{ route('logout.perform') }}" class="inline-block px-4 py-2 bg-red-600 text-white font-semibold rounded-lg shadow-lg hover:bg-red-700 transition-colors duration-300">Cerrar Sesión</a>
                </div>
            @endif
            @endauth
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-8">
                <div class="bg-gray-100 p-6 rounded-lg shadow-md">
                    ...
                    <div class="mt-4">
                        <a href="#" class="inline-block px-5 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-300">Ver Torneos</a>
                    </div>
                </div>
            </div>
        </div>
